...
use_ku_license <- function(
  ...
  c <- paste0(
    sprintf(
      paste0("# ", "Copyright \U00A9 %s %s. All rights reserved."),
      year,
      copyright_holder
    ),
    "\n#",
  ...
  if (full_version) {
    cat(
      ...
      sprintf(
        "\n# or sold without the written permission of a representative of the %s.",
        copyright_holder
      )
    )
  } else {
